...
import { BookOpen, LayoutDashboard, LogOut, Settings, Tags, UserPlus, Users } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="relative w-64 border-r border-gray-200 bg-white">
        <div className="flex h-16 items-center border-b border-gray-200 px-6">
          <span className="text-lg font-semibold text-gray-900">Education Admin</span>
        </div>
