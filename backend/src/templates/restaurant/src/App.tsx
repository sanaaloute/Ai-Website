...
import AdminMenuItems from '@/admin/pages/MenuItems';
    ...
    <Routes>
      ...
      <Route element={<AdminRouteGuard />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path="/admin/menu_items" element={<ErrorBoundary><AdminMenuItems /></ErrorBoundary>} />
          <Route path="/admin/categories" element={<ErrorBoundary><AdminCategories /></ErrorBoundary>} />
          <Route path="/admin/reservations" element={<ErrorBoundary><AdminReservations /></ErrorBoundary>} />
