migrate(
  (db) => {
    ...
    const menu_items = new Collection({
      id: 'menu_items',
      name: 'menu_items',
      type: 'base',
      system: false,
      ...
      indexes: ["CREATE UNIQUE INDEX `idx_menu_items_slug` ON `menu_items` (`slug`)"],
  ...
  (db) => {
    ...
    const collections = ["reservations", "menu_items", "categories"];
