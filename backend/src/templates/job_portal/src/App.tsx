    ...
    <Routes>
      ...
      <Route element={<AdminRouteGuard />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path="/admin/jobs" element={<ErrorBoundary><AdminJobs /></ErrorBoundary>} />
          <Route path="/admin/categories" element={<ErrorBoundary><AdminCategories /></ErrorBoundary>} />
          <Route path="/admin/applications" element={<ErrorBoundary><AdminApplications /></ErrorBoundary>} />
