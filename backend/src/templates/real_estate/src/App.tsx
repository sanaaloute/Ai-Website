    ...
    <Routes>
      ...
      <Route element={<AdminRouteGuard />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path="/admin/properties" element={<ErrorBoundary><AdminProperties /></ErrorBoundary>} />
          <Route path="/admin/categories" element={<ErrorBoundary><AdminCategories /></ErrorBoundary>} />
          <Route path="/admin/inquiries" element={<ErrorBoundary><AdminInquiries /></ErrorBoundary>} />
