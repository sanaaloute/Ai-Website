  ...
  getTools(context?: AgentContext): DynamicStructuredTool[] {
    ...
    const docsTools: DynamicStructuredTool[] = [
      ...
      new DynamicStructuredTool({
        name: 'docs_framework',
        description:
          'Fetch up-to-date documentation for a supported framework (react, vite, next, prisma, node, pocketbase, playwright). Use this when you need framework-specific API details.',
