...
const sandbox_lifecycle_service_1 = require("./sandbox-lifecycle.service");
let SandboxModule = class SandboxModule {
};
exports.SandboxModule = SandboxModule;
exports.SandboxModule = SandboxModule = __decorate([
    (0, common_1.Module)({
        controllers: [sandbox_controller_1.SandboxController],
        providers: [sandbox_service_1.SandboxService, sandbox_lifecycle_service_1.SandboxLifecycleService],
    })
], SandboxModule);
