...
class SandboxProvider {
    ...
    async listFiles(directory = WORKSPACE_ROOT) {
        ...
        const res = await this.e2b.runCommand(this.sandboxId, `find ${dir} -type f -not -path '*/node_modules/*' -not -path '*/.git/*' -not -path '*/.next/*' -not -path '*/dist/*' -not -path '*/.agent_state/*' | sort`, WORKSPACE_ROOT);
