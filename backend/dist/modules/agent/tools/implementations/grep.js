    ...
    async _call(args) {
        ...
        try {
            ...
            if (args.include_pattern) {
                cmdParts.push("--include", (0, shell_1.shellQuote)(args.include_pattern));
            }
            if (args.exclude_pattern) {
                cmdParts.push("--exclude", (0, shell_1.shellQuote)(args.exclude_pattern));
            }
            const limit = Math.min(args.limit ?? DEFAULT_LIMIT, MAX_LIMIT);
            cmdParts.push("-e", (0, shell_1.shellQuote)(args.query), ".");
