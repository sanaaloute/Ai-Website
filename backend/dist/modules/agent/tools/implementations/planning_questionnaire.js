...
exports.PlanningQuestionnaireTool = void 0;
...
const planningQuestionnaireSchema = zod_1.z.object({
    questions: zod_1.z
...
class PlanningQuestionnaireTool extends types_1.AgentTool {
    constructor() {
        super(...arguments);
        this.name = "planning_questionnaire";
        this.description = `Present a structured questionnaire to gather requirements from the user.
...
- "placeholder" (string, optional): Placeholder for text inputs`;
        this.schema = planningQuestionnaireSchema;
    }
    async _call(args) {
...
exports.PlanningQuestionnaireTool = PlanningQuestionnaireTool;
//# sourceMappingURL=planning_questionnaire.js.map