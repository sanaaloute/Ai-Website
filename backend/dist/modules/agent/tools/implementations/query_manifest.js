...
exports.QueryManifestTool = void 0;
const zod_1 = require("zod");
const types_1 = require("../types");
const queryManifestSchema = zod_1.z.object({
    action: zod_1.z
...
class QueryManifestTool extends types_1.AgentTool {
    constructor() {
        super(...arguments);
        this.name = "query_manifest";
        this.description = `Query the file state tracker manifest to check file statuses, list changed files, or verify protected paths.
...
- "is_protected": Check if a file path is protected (e.g., vite.config.ts, package.json)`;
        this.schema = queryManifestSchema;
    }
    async _call(args) {
...
exports.QueryManifestTool = QueryManifestTool;
//# sourceMappingURL=query_manifest.js.map