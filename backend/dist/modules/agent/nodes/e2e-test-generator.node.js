...
async function runE2eTests(state, deps, previewUrl, routesSource) {
    ...
    try {
        ...
        const rawCode = await deps.aiGateway.chatCompletionsStream(messages, deps.modelResolver.resolveSequence('e2e_test_generator'), state.aiCredentials, undefined, deps.signal, deps.modelResolver.generationParams('e2e_test_generator'));
