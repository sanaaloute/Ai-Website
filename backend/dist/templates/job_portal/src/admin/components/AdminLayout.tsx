...
import { Briefcase, LayoutDashboard, LogOut, Send, Settings, Tags, Users } from 'lucide-react';
...
const nav = [
  ...
  { label: 'Applications', to: '/admin/applications', icon: Send },
    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="relative w-64 border-r border-gray-200 bg-white">
        <div className="flex h-16 items-center border-b border-gray-200 px-6">
          <span className="text-lg font-semibold text-gray-900">Jobs Admin</span>
        </div>
