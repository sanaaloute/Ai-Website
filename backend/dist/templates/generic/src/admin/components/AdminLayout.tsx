...
import { Layout, LayoutDashboard, LogOut, Mail, Settings, Users } from 'lucide-react';
import { logout, currentUser } from '@/lib/pocketbase';

const nav = [
  { label: 'Dashboard', to: '/admin', icon: LayoutDashboard, end: true },
  { label: 'Pages', to: '/admin/pages', icon: Layout },
    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="relative w-64 border-r border-gray-200 bg-white">
        <div className="flex h-16 items-center border-b border-gray-200 px-6">
          <span className="text-lg font-semibold text-gray-900">Site Admin</span>
        </div>
