# SupportDesk — Customer Support Template

A production-ready **B2B SaaS landing page** template for a customer support & helpdesk product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
