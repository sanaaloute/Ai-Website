# NeuralWorks — AI Workflow Automation Template

A production-ready **B2B SaaS landing page** template for an AI workflow automation product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
...
- Hero with product dashboard mockup (metrics read from content)
