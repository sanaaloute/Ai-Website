# PeopleHub — HR & People Ops Template

A production-ready **B2B SaaS landing page** template for an HR & people operations product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
...
- Hero with people metrics (employees managed, onboarding time, hours saved)
