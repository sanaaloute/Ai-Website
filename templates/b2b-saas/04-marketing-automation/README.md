# BrightWave — Marketing Automation Template

A production-ready **B2B SaaS landing page** template for a marketing automation product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
