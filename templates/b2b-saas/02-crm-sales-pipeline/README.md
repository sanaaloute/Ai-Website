# DealFlow — CRM & Sales Pipeline Template

A production-ready **B2B SaaS landing page** template for a CRM & sales pipeline product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
