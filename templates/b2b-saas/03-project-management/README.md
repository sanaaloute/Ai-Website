# TaskPilot — Project Management Template

A production-ready **B2B SaaS landing page** template for a project management product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
