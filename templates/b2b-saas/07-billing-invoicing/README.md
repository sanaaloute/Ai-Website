# InvoiceFlow — Billing & Invoicing Template

A production-ready **B2B SaaS landing page** template for a billing & invoicing product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
...
- Hero with finance metrics (invoices sent, days to payment, revenue collected)
