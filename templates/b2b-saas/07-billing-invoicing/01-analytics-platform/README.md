# PulseMetrics — Analytics Platform Template

A production-ready **B2B SaaS landing page** template for an analytics product, built with **Next.js (App Router) + TypeScript + Tailwind CSS**.
